<section class="docs-section" id="item-1-1">
    ...
    <p><img src="<?=url('msgraph/createapp.png');?>" class="img-responsive"> </p>
    <p>Create a new application, name the application. Click continue the Application Id will then be displayed.</p>
    <p><img src="<?=url('msgraph/appid.png');?>" class="img-responsive"> </p>
    ...
    <p><img src="<?=url('msgraph/web-platform.png');?>" class="img-responsive"> </p>
    <p>Now under Microsoft Graph Permissions click add and select which permissions to use, a maximum of 20 can be selected.</p>
    <p><img src="<?=url('msgraph/permissions.png');?>" class="img-responsive"> </p>
