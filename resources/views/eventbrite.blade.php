...
@section('title', 'Laravel Eventbrite')

@section('meta')
@php
$title = 'Laravel Eventbrite - '.config('app.name');
$description = 'Documentation for DC Blog Laravel Eventbrite package';
@endphp
	    ...
	    <div class="docs-content">
		    <div class="container">
			    <article class="docs-article" id="section-1">
                    ...
                    @include('eventbrite/index')
                    @include('eventbrite/install/app')
                    @include('eventbrite/install/install')
                    @include('eventbrite/usage')
